...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceImpl(ProductRepository productRepository, ProductMapper productMapper, AppCategoryRepository appCategoryRepository, ProductMapImpl productMap) {
